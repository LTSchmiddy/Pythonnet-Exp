    ...
    public static bool Draw(InAudioEventNode audioevent)
    {
        ...
        if (audioevent._type == EventNodeType.Event)
        {
            ...
            if (Application.isPlaying)
            {
                ...
                {
                    // bool prefab = PrefabUtility.GetPrefabParent(eventObjectTarget) == null && PrefabUtility.GetCorrespondingObjectFromSource(eventObjectTarget) != null;
                    bool prefab = PrefabUtility.GetCorrespondingObjectFromSource(eventObjectTarget) == null && PrefabUtility.GetCorrespondingObjectFromSource(eventObjectTarget) != null;
                    if (!prefab)
                    {
